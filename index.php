...
<div class="container mt-4 d-flex justify-content-end">
    <div class="lang-switcher d-flex align-items-center">
        ...
        <a href="?lang=sk" class="<?php echo ($lang == 'sk') ? 'active-flag' : 'inactive-flag'; ?>" title="Slovensky">
            <img src="https://flagcdn.com/w40/sk.png" 
            ...
            <div class="row">
                <div class="col-md-4 border-end pe-md-4">
                    ...
                    <section class="mb-4">
                        ...
                        <a href="mailto:sutorasam@gmail.com" class="contact-item">
                            <span>sutorasam@gmail.com</span>
                        </a>
                        <br>
                        <i class="bi bi-telephone-fill"></i>
                        <a href="tel:+421907407116" class="contact-item">
                            <span>+421 907 407 116</span>
                        </a>
                        </div>
                ...
                <div class="col-md-8 ps-md-4">
                    ...
                    <section class="mb-4">
                        ...
                        <div class="text-primary mb-2 green">Hulman.sk</div>
                        <ul>
                            <li>HTML/CSS <?php echo $texts['website_maintenance']; ?>.</li>
                            <li><?php echo $texts['occasional_php_development']; ?>.</li>
                        </ul>
                        <!-- <button class="btn btn-secondary btn-sm"><?php echo $texts['more_info']; ?></button> -->
                        ...
                        <div class="text-primary mb-2">FBC Grasshoppers AC UNIZA Žilina</div>
                        <p><?php echo $texts['job_summary_1']; ?>.</p>
                        <!-- <button class="btn btn-secondary btn-sm"><?php echo $texts['more_info']; ?></button> -->
                    </section>
                    ...
                    <section class="mb-4">
                        ...
                        <div class="text-primary mb-2"><?php echo $texts['study_programme']; echo $texts['degree']; ?></div>
                        ...
                        <div class="text-primary mb-2"><?php echo $texts['high_school_summary']; ?></div>
                    </section>
